...
**`grid_update(power, freq, n_current)`** – Seite Netz: Leistung am Hausanschluss in W (positiv = Bezug, negativ = Einspeisung, wie `total_act_power` des Shelly Pro 3EM), Frequenz in Hz, Neutralleiterstrom in A.
